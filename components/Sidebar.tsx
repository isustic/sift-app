...
import { Sprout, BarChart3, Settings2, Database, History, PanelLeftClose, PanelLeft, FileSpreadsheet, Home, FlaskRound } from "lucide-react";
...
const navItems = [
    ...
    { href: "/test", label: "Test", icon: FlaskRound },
